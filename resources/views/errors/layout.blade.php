...
<head>
    ...
    <title>@yield('titulo', 'Error') · Sistema de Citas Medicas</title>
...
<body>
    <div class="error-card">
        ...
        <h1 class="h5 mt-2 mb-3" style="font-weight:700;">@yield('titulo')</h1>
        <p class="text-muted mb-4">@yield('mensaje')</p>
        <a href="{{ url('/') }}" class="btn-volver"><i class="bi bi-house-door me-1"></i>Volver al inicio</a>
    </div>
</body>
</html>
