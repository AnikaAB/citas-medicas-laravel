...
<form method="POST" action="{{ route('recepcionistas.update', $recepcionista) }}" style="max-width: 480px;">
    @csrf
    @method('PUT')
    <div class="mb-3">
        <label class="form-label">Nombre completo</label>
        <input type="text" name="name" class="form-control" value="{{ old('name', $recepcionista->name) }}" required autofocus>
    </div>
    <div class="mb-3">
