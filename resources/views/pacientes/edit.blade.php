...
<form method="POST" action="{{ route('pacientes.update', $paciente) }}">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3"><label class="form-label">Telefono</label><input name="telefono" class="form-control" required pattern="[0-9]{7,10}" title="Solo numeros, entre 7 y 10 digitos" value="{{ $paciente->telefono }}"></div>
    </div>
