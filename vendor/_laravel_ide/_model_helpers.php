...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Cita>|Cita wherePacienteId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Cita>|Cita whereDoctorId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Cita>|Cita whereCreadoPor($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Cita>|Cita whereMotivo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Cita>|Cita whereEstado($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Cita>|Cita whereObservaciones($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereApellido($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereEspecialidad($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereTelefono($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereHorarioInicio($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Doctor>|Doctor whereHorarioFin($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereApellido($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereCedula($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereTelefono($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereFechaNacimiento($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereDireccion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Paciente>|Paciente query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Paciente extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
