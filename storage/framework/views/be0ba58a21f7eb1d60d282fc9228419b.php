...
<body>
        ...
        <div class="container" style="max-width: 1180px;">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php if(in_array(auth()->user()->rol, ['admin','recepcionista','doctor'])): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('citas.*') ? 'active' : ''); ?>" href="<?php echo e(route('citas.index')); ?>">
                                <i class="bi bi-calendar2-week"></i>Citas
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if(auth()->user()->esPaciente()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('paciente.citas.*') ? 'active' : ''); ?>" href="<?php echo e(route('paciente.citas.index')); ?>">
                                <i class="bi bi-calendar2-heart"></i>Mis citas
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if(in_array(auth()->user()->rol, ['admin','recepcionista'])): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('pacientes.*') ? 'active' : ''); ?>" href="<?php echo e(route('pacientes.index')); ?>">
                    ...
                    <?php if(auth()->user()->rol === 'admin'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('doctores.*') ? 'active' : ''); ?>" href="<?php echo e(route('doctores.index')); ?>">
                    ...
                    <?php if(auth()->user()->esPaciente()): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('perfil.*') ? 'active' : ''); ?>" href="<?php echo e(route('perfil.edit')); ?>">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="user-chip">
                        ...
                        <span class="rol-tag"><?php echo e(auth()->user()->rol); ?></span>
                    </div>
    ...
    <div class="page-shell">
        <?php if(session('exito')): ?>
            <div class="alert alert-success"><i class="bi bi-check-circle me-1"></i><?php echo e(session('exito')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
...
<?php /**PATH C:\Users\Usuario\Downloads\citas-medicas-laravel-MERGED\final\resources\views/layouts/app.blade.php ENDPATH**/ ?>