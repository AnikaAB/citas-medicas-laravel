    ...
    <style>
        ...
        * { font-family: 'Inter', sans-serif; }
        ...
        .auth-side {
            position: relative;
            background:
                radial-gradient(600px 400px at 100% 0%, rgba(20,184,166,0.35), transparent 60%),
        ...
        .auth-side h2 { font-weight: 800; letter-spacing: -0.02px; margin-top: 22px; }
        ...
        .auth-form-wrap h3 { font-weight: 800; color: var(--ink); }
        .auth-form-wrap .subtitle { color: #6b7280; margin-bottom: 28px; }
        .form-control {
        ...
        .switch-link a { color: var(--brand-1); font-weight: 600; text-decoration: none; }
...
<?php /**PATH C:\Users\Usuario\Downloads\citas-medicas-laravel-actualizado\citas-medicas-laravel\resources\views/layouts/auth.blade.php ENDPATH**/ ?>