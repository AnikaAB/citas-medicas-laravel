        ...
        <div class="container" style="max-width: 1180px;">
            ...
            <div class="collapse navbar-collapse" id="navMenu">
                <ul class="navbar-nav me-auto">
                    ...
                    <?php endif; ?>
                    <?php if(auth()->user()->rol === 'paciente'): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->routeIs('mis-citas.*') ? 'active' : ''); ?>" href="<?php echo e(route('mis-citas.index')); ?>">
...
<?php /**PATH C:\Users\Usuario\Desktop\Proyecto de Ingieneria de Software H2\citas-medicas-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>